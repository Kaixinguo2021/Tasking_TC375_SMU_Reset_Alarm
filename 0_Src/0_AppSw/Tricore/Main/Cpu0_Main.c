 ...
 * IN THE SOFTWARE.
 *********************************************************************************************************************/
 /*\title Reset triggered by an SMU alarm
 ...
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_SMU_Reset_Alarm_1_KIT_TC375_LK-TR-v01_00_01-EN.pdf
...
void core0_main(void)
{
    ...
    Debugger_printf("core0_main init\r\n");
    //wait 20ms
    IfxStm_waitTicks(&MODULE_STM0, 2000000);
    config_SMU_reset();     /* Configure the SMU            */
    trigger_SMU_reset();    /* Trigger the Software Alarm 0 */
