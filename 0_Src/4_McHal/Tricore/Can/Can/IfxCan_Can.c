...
void IfxCan_Can_setStandardFilter(IfxCan_Can_Node *node, IfxCan_Filter *filter)
{
    ...
    Ifx_CAN_STDMSG *standardFilterElement2 = ((uint32*)(node->messageRAM.baseAddress + node->messageRAM.standardFilterListStartAddress + 4));
    standardFilterElement2->S0.B.SFID2 = 0x188;
    standardFilterElement2->S0.B.SFID1 = 0x188;
    standardFilterElement2->S0.B.SFEC = 0x01;
    /* 111B Store into Rx Buffer or as debug message, configuration of SFT[1:0] ignored */
    // standardFilterElement2->S0.B.SFEC = 0x07;
    /* 10B Classic filter: SF1ID = filter, SF2ID = mask */
    standardFilterElement2->S0.B.SFT = 0x02;
    ...
    // standardFilterElement->S0.B.SFEC = 0x07;
